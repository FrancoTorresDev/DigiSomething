...
<template>
  <div class="bg-ds-navy rounded-xl p-4 border border-ds-neon/20">
    <div class="flex flex-wrap gap-3 items-center">
      ...
      <select
        ...
        class="bg-ds-midnight text-sm text-ds-soft-white px-3 py-2 rounded-lg border border-ds-neon/30 focus:border-ds-cyan focus:outline-none transition-colors"
      >
